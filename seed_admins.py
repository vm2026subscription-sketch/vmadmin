...
print(f"Admins created: {created}, skipped: {skipped}")import os
from datetime import datetime
...
MONGODB_URI = os.environ.get(
    "MONGODB_URI",
    "mongodb+srv://vm2026subscription_db_user:hKo3qDFfXOEmihiE@attendance.qpqmaha.mongodb.net/?appName=attendance",
)
MONGO_DB_NAME = os.environ.get("MONGO_DB_NAME", "vmadmin")
